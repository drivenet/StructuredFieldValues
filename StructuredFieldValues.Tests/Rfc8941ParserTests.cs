...
namespace StructuredFieldValues.Tests
{
    public class Rfc8941ParserTests
    {
        ...
        [InlineData("0", 0, 0, 1)]
        [InlineData("1", 0, 1, 1)]
        [InlineData("-17", 0, -17, 3)]
        [InlineData("2873913q123", 0, 2873913, 7)]
        [InlineData("q1232873913", 4, 2873913, 11)]
        [InlineData("1zxcc", 0, 1, 1)]
        [InlineData("-913vwe", 0, -913, 4)]
        [InlineData("1239712839", 0, 1239712839, 10)]
