...
namespace StructuredFieldValues
{
    public sealed class Token : IEquatable<Token>, IEquatable<string>
    {
        ...
        public static bool operator ==(Token? left, string? right) => left is object ? left.Equals(right) : right is null;

        public static bool operator !=(Token? left, string? right) => !(left == right);

        public static bool operator ==(string? left, Token? right) => right is object ? right.Equals(left) : left is null;
...
#pragma warning restore CA1307 // Specify StringComparison for clarity
        ...
        public bool Equals(Token? other) => other is object && _value == other._value;
